function [coeficientes, ecm] = fourierParte2e3(alturas)
  ...
  fi12 = cos(((2 * pi)/cantidad_horas) * 364 * x);
  fi13 = sin(((2 * pi)/cantidad_horas) * 364 * x);
  ...
  M=[fi1*fi1' fi1*fi2' fi1*fi3' fi1*fi4' fi1*fi5' fi1*fi6' fi1*fi7' fi1*fi8' fi1*fi9' fi1*fi10' fi1*fi11' fi1*fi12' fi1*fi13';
    ...
    fi10*fi1' fi10*fi2' fi10*fi3' fi10*fi4' fi10*fi5' fi10*fi6' fi10*fi7' fi10*fi8' fi10*fi9' fi10*fi10' fi11*fi11' fi10*fi12' fi10*fi13';
  ...
  b = [y*fi1'; y*fi2'; y*fi3' ; y*fi4' ;y*fi5'; y*fi6' ;y*fi7'; y*fi8' ;y*fi9'; y*fi10' ;y*fi11'; y*fi12' ;y*fi13'];
  coeficientes = inv(M)*b;

  ycalc = coeficientes(1)*fi1 +coeficientes(2)*fi2 + coeficientes(3)*fi3 + coeficientes(4)*fi4 + coeficientes(5)*fi5 + coeficientes(6)*fi6 + coeficientes(7)*fi7 + coeficientes(8)*fi8 + coeficientes(9)*fi9 + coeficientes(10)*fi10 + coeficientes(11)*fi11 + coeficientes(12)*fi12 + coeficientes(13)*fi13;
